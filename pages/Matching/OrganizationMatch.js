...
let OrganizationMatch = ({ route, navigation }) => {
    ...
    return (
        <View flex padding-page centerH>
            ...
            <Text center body fadedSubtext marginB-s4 marginT-s6>We assigned you and {JSON.stringify(name)} an organization to volunteer at: <Text bold>{JSON.stringify(organization)}</Text></Text>
            ...
            <Card height={100} width={100} marginB-s4 backgroundColor={"#A4C1E3"}>

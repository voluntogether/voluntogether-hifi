      ...
      <View style={StylesJournal.journalcontainer} marginT-s4>
        <View style={StylesJournal.rowContainer}>
          <Pressable>
            <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH >
                ...
                <Svg width="116" height="113" viewBox="0 0 116 113" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
          ...
          <Pressable onPress={() => navigation.navigate('ViewPrompts',
            ...
            <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH >
                ...
                <Svg width="101" height="108" viewBox="0 0 101 108" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
        ...
        <View style={StylesJournal.rowContainer}>
          <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH >
            ...
            <Svg width="128" height="103" viewBox="0 0 128 103" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
          ...
          <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH >
            <Text categoryTitle nonWhiteWhite marginB-s4>Lessons</Text>
            <Svg width="110" height="100" viewBox="0 0 110 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>

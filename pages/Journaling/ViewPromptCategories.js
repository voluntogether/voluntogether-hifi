      ...
      <View style={StylesJournal.journalcontainer} marginT-s4>
        <View style={StylesJournal.rowContainer}>
          <Pressable>
            <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH alignItems="center">
                ...
                <View>
                  <Svg alignItems="center" justifyContent="center" width="116" height="113" viewBox="0 0 116 113" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]} >
          ...
          <Pressable onPress={() => navigation.navigate('ViewPrompts',
            ...
            <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH alignItems="center">
                ...
                <View>  
                  <Svg alignItems="center" justifyContent="center" width="101" height="108" viewBox="0 0 101 108" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
                    ...
                    <View> 
                      <FontAwesome5 name={'mountain'} size={40} color={"white"}/>
                    </View>
                  </Svg>
                </View>
        ...
        <View style={StylesJournal.rowContainer}>
          <Card style={[StylesJournal.blueCardJournal, Styles.boxShadow]} centerH alignItems="center">
            ...
            <View> 
              <Svg alignItems="center" justifyContent="center" width="128" height="103" viewBox="0 0 128 103" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
                  ...
                  <View> 
                      <FontAwesome5 name={'brightness'} size={40} color={"white"}/>
                  </View>
              </Svg>
            </View>
          </Card>
          ...
          <View> 
            ...
            <Svg alignItems="center" justifyContent="center" width="110" height="100" viewBox="0 0 110 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={[Styles.boxShadow]}>
                ...
                <View> 
                    <FontAwesome5 name={'memo'} size={40} color={"white"}/>
                </View>
            </Svg>
          </View>

...
let ViewThreads = ({ navigation, route }) => {
  ...
  return (
      ...
      <View centerH>
        <Svg style={{justifyContent: 'center',alignItems: 'center'}} width="267" height="263" viewBox="0 0 267 263" fill="none" xmlns="http://www.w3.org/2000/svg">
          <View style={{justifyContent: 'center',alignItems: 'center'}}>
            <FontAwesome5 style={{justifyContent: 'center',alignItems: 'center'}} name={'book'} size={40} color={"white"} />
          </View>
